...
ldem_file = 'pdf/For_a_Fair_Deal_-_Liberal_Democrat_Manifesto_2024.pdf'
text = extract_text(ldem_file)

## Remove header lines
### These have 'Change  Labour Party Manifesto 2024'
pattern = r"Liberal Democrat Election Manifesto 2024"
...
# Define a regular expression pattern to match lines that ldemsist only of a number
pattern = r'^\d+$'
...
with open('cleaned/ldem.txt', 'w') as file:
